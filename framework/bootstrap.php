...
/**
 * Bootstrap framework part of Isopress structure.
 *
 * Components is the "mu-plugins" directory with a new name.
 * This file will load all plugins in sub directories.
 *
 * @version 1.0.0
 */
